<h1>👋 Welcome to Natasha Saini's Portfolio! 🚀 <a href="https://github.com/NATASHASAINI"></a>  
Explore my projects in AI, Machine Learning, and Cloud Security & discover my research publications featured in IEEE, Scopus, Springer, and more below.
...
<b>AI/ML:Python,Numpy,Pandas,Scikit-Learn,TensorFlow,Keras,Matplotlib,Hugging face,OpenAI,MongoDBVector embedding</b>
   ...
   - [Remembrance – Built and containerized a FastAPI-based AI memory intelligence platform integrating Supabase, FAISS vector search, GPT-4o, and A/B testing workflows to process,   retrieve, and optimize insights from multimodal data (audio, video, PDFs, and text).](https://github.com/NATASHASAINI/Remembrance) <b></b>
...
<b>Certifications</b>:
   ...
   - [Kaggle:Timeseries in Machine Learning](https://www.kaggle.com/learn/certification/natashasaini/time-series) <b></b>
